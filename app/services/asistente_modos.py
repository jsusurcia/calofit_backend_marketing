...
def bloque_prompt_modo_funcion(modo: str) -> str:
    ...
    instrucciones = {
        ...
        RECOMENDAR_EJERCICIO: (
            ...
            "• Debes diferenciar la intención del usuario:\n"
            "   A) Si pide una RUTINA, ENTRENAMIENTO o PLAN: Debes usar [CALOFIT_INTENT:POWER] al inicio y estructurar "
            "tarjetas interactivas usando [CALOFIT_HEADER], [CALOFIT_LIST] (volumen), [CALOFIT_ACTION] (técnica) y [CALOFIT_STATS] (duración/calorías) POR CADA EJERCICIO INDIVIDUALMENTE.\n"
            "      • EJEMPLO CORRECTO OBLIGATORIO PARA RUTINA (UN BLOQUE POR EJERCICIO):\n"
            ...
            "[/CALOFIT_LIST]\n"
            "[CALOFIT_ACTION]\n"
            "Técnica: Mantén la espalda recta y baja hasta romper el paralelo.\n"
            "[/CALOFIT_ACTION]\n"
            "[CALOFIT_STATS]Dur: 20 min | Cal: 200 kcal[/CALOFIT_STATS]\n"
            "   B) Si solo pide SUGERENCIAS, QUÉ EJERCICIOS HACER o TÉCNICA: Usa [CALOFIT_INTENT:INFO] al inicio. "
            "No uses etiquetas CALOFIT. Haz un listado Markdown bien formateado, enseñando la técnica, recomendando "
            "series/repeticiones y peso o tiempo bajo tensión.\n"
            "• REGLA DE TIEMPO (IMPORTANTE): Siempre que estructures rutinas, debes sumar el tiempo de todos los "
            "ejercicios e indicar el TOTAL en MINUTOS de forma explícita (ej. '45 min', '60 minutos') en [CALOFIT_STATS].\n"
