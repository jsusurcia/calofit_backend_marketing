...
from .routes import usuarios, nutricion, auth, clientes, asistente, dashboard, admin, alertas, balance, alimentos, nutricionista, copiloto, pagos
...
api_router.include_router(copiloto.router, prefix="/copiloto", tags=["Asistente Staff (Copiloto)"])
